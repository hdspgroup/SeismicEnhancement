...
from transferutils import get_result, normalize, preprocess_image, loader
...
if __name__ == '__main__':
    ...
    content_img = loader(
        preprocess_image('../data/patch_21.jpg', fig_size=128)).unsqueeze(0).to('cpu',torch.float)
    #input_img = content_img.clone()
